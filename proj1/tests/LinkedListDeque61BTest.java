...
public class LinkedListDeque61BTest {
     ...
     public void getFirstTest() {
         Deque61B<String> lld1 = new LinkedListDeque61B<>();
         lld1.addFirst("back");
         assertThat(lld1.toList().get(0)).isEqualTo("back");
         lld1.addFirst("middle");
         assertThat(lld1.toList().get(0)).isEqualTo("middle");
         lld1.addFirst("front");
         assertThat(lld1.toList().get(0)).isEqualTo("front");
     }
     ...
     public void getLastTest() {
         Deque61B<String> lld1 = new LinkedListDeque61B<>();
         lld1.addLast("back");
         assertThat(lld1.toList().get(lld1.size() - 1)).isEqualTo("back");
         lld1.addLast("middle");
         assertThat(lld1.toList().get(lld1.size() - 1)).isEqualTo("middle");
         lld1.addLast("front");
         assertThat(lld1.toList().get(lld1.size() - 1)).isEqualTo("front");
     }
